    ...
    for grouping_year, generator in df.index:
        ...
        if generator in ["solar", "onwind", "offwind-ac"]:
            ...
            if not new_build.empty:
                ...
                if generator in ["nuclear", "coal", "lignite", "oil", "OCGT", "CCGT"] and grouping_year < 2011:
                    n.madd(
                        "Link",
                        new_capacity.index,
                        suffix=name_suffix,
                        ...
                        * costs.at[generator, "FOM"]* 0.01 # FOM in % of investment
                        * costs.at[generator, "investment"] * n.snapshot_weightings.generators.sum()/8760,  # no annuity payment for those powerplants
                ...
                elif generator != "urban central solid biomass CHP":
                    n.madd(
                        "Link",
                        new_capacity.index,
                        suffix=name_suffix,
