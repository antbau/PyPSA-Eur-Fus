...
def add_BAU_constraints(n, config):
    ...
    if config.get("capacity_constraints") and "BAU_maxcapacities" in config["capacity_constraints"]:    
    ...
    if "bau_maxcaps" in n.model.constraints:
    ...
    if "bau_mincaps" in n.model.constraints:
